...
exports.renderDiagramFormHtml = renderDiagramFormHtml;
exports.renderDiagramStatusHtml = renderDiagramStatusHtml;
exports.renderDiagramResultsHtml = renderDiagramResultsHtml;
exports.renderDiagramErrorHtml = renderDiagramErrorHtml;
function esc(raw) {
    return raw
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
...
function renderDiagramFormHtml(input) {
...
function renderDiagramStatusHtml(record) {
...
function renderDiagramResultsHtml(record) {
...
function renderDiagramErrorHtml(title, message) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
