...
exports.GEMINI_DIAGRAM_DETECTOR_SCHEMA = void 0;
exports.GEMINI_DIAGRAM_DETECTOR_SCHEMA = {
    type: 'object',
    properties: {
        diagrams: {
            type: 'array',
            description: 'Ordered list of diagrams found in the image (top-to-bottom, then left-to-right). ' +
            ...
            items: {
                ...
                properties: {
                    diagram_index: {
                        type: 'integer',
                        description: '1-based reading-order index. First diagram is 1, second is 2, etc.',
                        minimum: 1,
                    },
                    bbox_1000: {
                        type: 'array',
                    ...
                    label: {
                        type: 'string',
                        description: 'Optional caption text spotted near the diagram (e.g. "図1", "Fig. 2"). ' +
