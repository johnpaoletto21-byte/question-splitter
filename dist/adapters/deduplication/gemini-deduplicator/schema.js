...
exports.GEMINI_DEDUPLICATION_SCHEMA = void 0;
exports.buildGeminiDeduplicationSchema = buildGeminiDeduplicationSchema;
function buildGeminiDeduplicationSchema() {
    return {
        type: 'object',
        properties: {
            targets: {
...
exports.GEMINI_DEDUPLICATION_SCHEMA = buildGeminiDeduplicationSchema();
