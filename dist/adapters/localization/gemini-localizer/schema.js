...
exports.GEMINI_LOCALIZATION_SCHEMA = {
    type: 'object',
    properties: {
        regions: {
            type: 'array',
            description: 'Ordered bounding box entries for each page region of this target. ' +
            ...
            items: {
                ...
                properties: {
                    page_number: {
                        type: 'integer',
                        description: '1-based page number for this region (must match the page number given in the prompt).',
                        minimum: 1,
                    },
                    bbox_1000: {
                        type: 'array',
        ...
        review_comment: {
            type: 'string',
            description: 'Optional note when localization is uncertain, the target is partially off-page, ' +
