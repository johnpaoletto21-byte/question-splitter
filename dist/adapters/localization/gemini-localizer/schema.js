...
exports.GEMINI_LOCALIZATION_SCHEMA = void 0;
exports.buildGeminiLocalizationSchema = buildGeminiLocalizationSchema;
/** Build the JSON schema for window-based localization. */
function buildGeminiLocalizationSchema(windowSize = 3) {
    return {
        type: 'object',
        properties: {
            targets: {
                type: 'array',
                description: 'List of question bounding boxes found in the provided images. ' +
                ...
                items: {
                    ...
                    properties: {
                        question_number: {
                            type: 'string',
                            description: 'The question number from the provided question list (e.g. "1", "2", "問3"). ' +
                                'Must match exactly one entry in the question list.',
                        },
                        image_position: {
                            type: 'integer',
                            description: `Which image this bounding box is on (1 = first image, 2 = second, 3 = third). ` +
                        ...
                        bbox_1000: {
                            type: 'array',
                            description: 'Normalized bounding box [y_min, x_min, y_max, x_max] on a 0–1000 scale. ' +
            ...
            review_comment: {
                type: 'string',
                description: 'Optional note when localization is uncertain or bbox confidence is low.',
            },
        },
        required: ['targets'],
    };
...
exports.GEMINI_LOCALIZATION_SCHEMA = buildGeminiLocalizationSchema(3);
