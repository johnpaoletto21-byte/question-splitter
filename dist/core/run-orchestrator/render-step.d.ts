 ...
 */
export type PageRenderer = (source: PdfSource, outputDir: string) => Promise<PreparedPageImage[]>;
/**
 ...
 */
export declare function renderAllSources(context: RunContext, renderer: PageRenderer): Promise<RunContext & {
    preparedPages: PreparedPageImage[];
}>;
//# sourceMappingURL=render-step.d.ts.map