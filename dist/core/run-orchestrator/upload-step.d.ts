 ...
 */
export type DriveUploaderFn = (filePath: string, targetId: string, folderId: string, oauthTokenPath: string) => Promise<{
 ...
 */
export declare function runUploadStep(runId: string, rows: FinalResultRow[], folderId: string, oauthTokenPath: string, driveUploader: DriveUploaderFn): Promise<FinalResultRow[]>;
//# sourceMappingURL=upload-step.d.ts.map