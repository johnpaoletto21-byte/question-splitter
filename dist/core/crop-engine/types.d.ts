 ...
 */
export declare class BboxInvalidError extends Error {
    readonly targetId: string;
    readonly bbox: [number, number, number, number];
    readonly code: "BBOX_INVALID";
    /**
     ...
     */
    constructor(targetId: string, bbox: [number, number, number, number], reason: string);
}
/**
