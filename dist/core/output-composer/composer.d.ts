 ...
 */
export type ImageStackerFn = (targetId: string, topPath: string, bottomPath: string) => Promise<string>;
/**
 ...
 */
export declare function composeOutput(input: ComposerInput, imageStacker: ImageStackerFn): Promise<ComposerResult>;
